# Contributing to Alphhaspace

Thank you for your interest in contributing to Alphhaspace! This document provides guidelines and instructions for contributing to the project.
...
If you want to run Alphhaspace from source (for development or testing unreleased features), follow these steps:
...
Alphhaspace automatically downloads prebuilt binaries for Windows. If prebuilts aren't available for your Electron version yet, you'll need Visual Studio Build Tools:
...
Alphhaspace consists of two main parts:
...
Thank you for contributing to Alphhaspace!
