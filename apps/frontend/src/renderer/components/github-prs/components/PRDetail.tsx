...
export function PRDetail({
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const approvalMessage = `## ✅ Alphhaspace PR Review - APPROVED\n\n${reviewResult.summary}\n\n---\n*This approval was generated by Alphhaspace.*`;
  ...
  const handleAutoApprove = async () => {
    ...
    try {
      ...
      const approvalMessage = `## Alphhaspace Review - APPROVED
