          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="alphhaspace">{t('general.agentFrameworkAutoClaude')}</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-3">
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <Label htmlFor="autoBuildPath" className="text-sm font-medium text-foreground">{t('general.alphhaspacePath')}</Label>
          <p className="text-sm text-muted-foreground">{t('general.alphhaspacePathDescription')}</p>
          <Input
            id="autoBuildPath"
            placeholder={t('general.alphhaspacePathPlaceholder')}
            className="w-full max-w-lg"
