...
/**
 * Check alphhaspace version status for a project
 */
...
/**
 * Initialize alphhaspace in a project
 */
  ...
  try {
    ...
    if (result.success && result.data) {
      ...
      if (result.data.success) {
        console.log('[ProjectStore] Updating project autoBuildPath to .alphhaspace');
        store.updateProject(projectId, { autoBuildPath: '.alphhaspace' });
      } else {
