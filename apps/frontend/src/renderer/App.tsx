...
export function App() {
  ...
  // GitHub setup state (shown after Alphhaspace init)
  ...
  // Check if selected project needs initialization (e.g., .alphhaspace folder was deleted)
  useEffect(() => {
  ...
  const handleInitialize = async () => {
    ...
    try {
      ...
      if (result?.success) {
        ...
        const errorMessage = result?.error || 'Failed to initialize Alphhaspace. Please try again.';
  ...
  return (
    <ViewStateProvider>
      ...
      <div className="flex h-screen bg-background">
        ...
        {/* GitHub Setup Modal - shows after Alphhaspace init to configure GitHub */}
        {gitHubSetupProject && (
          <GitHubSetupModal
