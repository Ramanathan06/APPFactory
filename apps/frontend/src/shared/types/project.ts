...
export interface GraphitiProviderConfig {
  ...
  dbPath?: string;    // Database storage path (default: ~/.alphhaspace/memories)
}
 ...
 * Stored in .alphhaspace/.env as AGENT_MCP_<agent>_ADD and AGENT_MCP_<agent>_REMOVE
 */
...
// Alphhaspace Initialization Types
export interface AutoBuildVersionInfo {
  isInitialized: boolean;
  updateAvailable: boolean; // Always false - .alphhaspace only contains data, no code to update
}
