...
- Manages Python and alphhaspace source path configuration
- Detects alphhaspace installation automatically
- Loads environment variables from alphhaspace .env file
