...
export function registerEnvHandlers(
  ...
  const generateEnvContent = (
    ...
    const content = `# Alphhaspace Framework Environment Variables
# Managed by Alphhaspace UI
...
# If not set, Alphhaspace will auto-detect main/master, or fall back to current branch
...
${existingVars['GRAPHITI_DB_PATH'] ? `GRAPHITI_DB_PATH=${existingVars['GRAPHITI_DB_PATH']}` : '# GRAPHITI_DB_PATH=~/.alphhaspace/memories'}
`;
