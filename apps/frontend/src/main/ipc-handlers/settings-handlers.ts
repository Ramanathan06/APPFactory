...
import { getEffectiveVersion } from '../alphhaspace-updater';
...
/**
 * Auto-detect the alphhaspace source path relative to the app location.
...
const detectAutoBuildSourcePath = (): string | null => {
  ...
  for (const p of possiblePaths) {
    ...
    // This prevents matching legacy 'alphhaspace/' directories that don't have the runners
  ...
  console.warn('[detectAutoBuildSourcePath] Could not auto-detect Alphhaspace source path. Please configure manually in settings.');
