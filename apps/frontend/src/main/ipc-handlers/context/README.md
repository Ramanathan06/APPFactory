...
This directory contains the refactored context-related IPC handlers for the Alphhaspace UI application. The handlers manage project context, memory systems (both file-based and Graphiti/LadybugDB), and project index operations.
...
test('buildMemoryStatus returns correct status', () => {
  const status = buildMemoryStatus('/path/to/project', 'alphhaspace');
...
- [Project Memory System](../../../../alphhaspace/memory.py)
- [Graphiti Memory Integration](../../../../alphhaspace/graphiti_memory.py)
