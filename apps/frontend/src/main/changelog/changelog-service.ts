...
export class ChangelogService extends EventEmitter {
   ...
   * Checks DEBUG from alphhaspace/.env and DEBUG from process.env
   */
  ...
  /**
   * Debug logging - only logs when DEBUG=true in alphhaspace/.env or DEBUG is set
   */
  ...
  /**
   * Get the alphhaspace source path (detects automatically if not configured)
   */
  ...
  /**
   * Load environment variables from alphhaspace .env file
   */
