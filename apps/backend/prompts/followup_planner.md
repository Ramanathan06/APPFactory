...
Next Steps:
Run `python alphhaspace/run.py --spec [SPEC_NUMBER]` to continue with new subtasks.
...
To continue building:
  python alphhaspace/run.py --spec [SPEC_NUMBER]
...
This spec has never been built. Please run:
  python alphhaspace/run.py --spec [NUMBER]
