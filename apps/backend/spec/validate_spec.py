...
Usage:
    python alphhaspace/validate_spec.py --spec-dir alphhaspace/specs/001-feature/ --checkpoint prereqs
    python alphhaspace/validate_spec.py --spec-dir alphhaspace/specs/001-feature/ --checkpoint context
    python alphhaspace/validate_spec.py --spec-dir alphhaspace/specs/001-feature/ --checkpoint spec
    python alphhaspace/validate_spec.py --spec-dir alphhaspace/specs/001-feature/ --checkpoint plan
    python alphhaspace/validate_spec.py --spec-dir alphhaspace/specs/001-feature/ --checkpoint all
"""
