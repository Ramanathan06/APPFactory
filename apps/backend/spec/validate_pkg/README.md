...
# Create validator
spec_dir = Path("alphhaspace/specs/001-feature")
...
python alphhaspace/validate_spec.py --spec-dir alphhaspace/specs/001-feature/ --auto-fix --checkpoint plan

# JSON output
python alphhaspace/validate_spec.py --spec-dir alphhaspace/specs/001-feature/ --checkpoint all --json
```
