...
from init import init_alphhaspace_dir
...
def get_specs_dir(project_dir: Path) -> Path:
    ...
    IMPORTANT: Only .alphhaspace/ is considered an "installed" alphhaspace.
    The alphhaspace/ folder (if it exists) is SOURCE CODE being developed,
    not an installation. This allows Alphhaspace to be used to develop itself.

    This function also ensures .alphhaspace is added to .gitignore on first use.

    Args:
        project_dir: The project root directory

    Returns:
        Path to the specs directory within .alphhaspace/
    """
    # Initialize .alphhaspace directory and ensure it's in .gitignore
    init_alphhaspace_dir(project_dir)

    # Return the specs directory path
    return project_dir / ".alphhaspace" / "specs"
