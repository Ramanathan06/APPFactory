"""
Alphhaspace CLI - Main Entry Point
===================================

Command-line interface for the Alphhaspace autonomous coding framework.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Alphhaspace Framework - Autonomous multi-session coding agent",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # List all specs
  python alphhaspace/run.py --list

  # Run a specific spec (by number or full name)
  python alphhaspace/run.py --spec 001
  python alphhaspace/run.py --spec 001-initial-app

  # Workspace management (after build completes)
  python alphhaspace/run.py --spec 001 --merge     # Add build to your project
  python alphhaspace/run.py --spec 001 --review    # See what was built
  python alphhaspace/run.py --spec 001 --discard   # Delete build (with confirmation)

  # Advanced options
  python alphhaspace/run.py --spec 001 --direct       # Skip workspace isolation
  python alphhaspace/run.py --spec 001 --isolated     # Force workspace isolation

  # Status checks
  python alphhaspace/run.py --spec 001 --review-status  # Check human review status
  python alphhaspace/run.py --spec 001 --qa-status      # Check QA validation status
...
def main() -> None:
    ...
    if not args.spec:
        ...
        print("\nUsage:")
        print("  python alphhaspace/run.py --list           # See all specs")
        print("  python alphhaspace/run.py --spec 001       # Run a spec")
