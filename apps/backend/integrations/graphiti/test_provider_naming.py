...
Shows how Alphhaspace automatically generates provider-specific database names
...
def test_provider_naming():
    ...
    for provider, model, dim in providers:
        ...
        db_name = config.get_provider_specific_database_name("alphhaspace_memory")
        ...
        print(f"  Full Path: ~/.alphhaspace/memories/{db_name}/")
        print()
