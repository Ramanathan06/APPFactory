...
Environment Variables:
    ...
    # Database
    GRAPHITI_DATABASE: Graph database name (default: alphhaspace_memory)
    GRAPHITI_DB_PATH: Database storage path (default: ~/.alphhaspace/memories)
...
DEFAULT_DATABASE = "alphhaspace_memory"
DEFAULT_DB_PATH = "~/.alphhaspace/memories"
...
class GraphitiConfig:
    ...
    def get_provider_specific_database_name(self, base_name: str = None) -> str:
        ...
        Returns:
            Database name with provider signature (e.g., "alphhaspace_memory_ollama_768")
        """
...
@dataclass
class GraphitiState:
    """State of Graphiti integration for an alphhaspace spec."""
