...
Central registry for creating and managing alphhaspace MCP tools.
"""
...
def create_alphhaspace_mcp_server(spec_dir: Path, project_dir: Path):
    """
    Create an MCP server with alphhaspace custom tools.
    ...
    return create_sdk_mcp_server(name="alphhaspace", version="1.0.0", tools=tools)
