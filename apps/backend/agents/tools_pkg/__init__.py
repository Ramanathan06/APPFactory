"""
Custom MCP Tools for Alphhaspace Agents
========================================

This module provides custom MCP tools that agents can use for reliable
operations on alphhaspace data structures. These tools replace prompt-based
...
Usage:
    from alphhaspace_tools import create_alphhaspace_mcp_server, get_allowed_tools

    # Create the MCP server
    mcp_server = create_alphhaspace_mcp_server(spec_dir, project_dir)
    ...
    options = ClaudeAgentOptions(
        mcp_servers={"alphhaspace": mcp_server},
...
from .registry import create_alphhaspace_mcp_server, is_tools_available
...
__all__ = [
    ...
    "ELECTRON_TOOLS",
    "PUPPETEER_TOOLS",
    # Alphhaspace tool name constants
    "TOOL_UPDATE_SUBTASK_STATUS",
    "TOOL_GET_BUILD_PROGRESS",
    "TOOL_RECORD_DISCOVERY",
    "TOOL_RECORD_GOTCHA",
