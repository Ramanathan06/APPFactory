...
Defines tool name constants and configuration for alphhaspace MCP tools.
...
- Alphhaspace tools: Custom build management tools
"""
...
# =============================================================================
# Alphhaspace MCP Tools (Custom build management)
# =============================================================================

# Alphhaspace MCP tool names (prefixed with mcp__alphhaspace__)
TOOL_UPDATE_SUBTASK_STATUS = "mcp__alphhaspace__update_subtask_status"
TOOL_GET_BUILD_PROGRESS = "mcp__alphhaspace__get_build_progress"
TOOL_RECORD_DISCOVERY = "mcp__alphhaspace__record_discovery"
TOOL_RECORD_GOTCHA = "mcp__alphhaspace__record_gotcha"
TOOL_GET_SESSION_CONTEXT = "mcp__alphhaspace__get_session_context"
TOOL_UPDATE_QA_STATUS = "mcp__alphhaspace__update_qa_status"
...
AGENT_CONFIGS = {
    ...
    "planner": {
        ...
        "mcp_servers": ["context7", "graphiti", "alphhaspace"],
    ...
    "qa_reviewer": {
        ...
        "mcp_servers": ["context7", "graphiti", "alphhaspace", "browser"],
...
def get_agent_config(agent_type: str) -> dict:
    ...
    Returns:
        Configuration dict containing tools, mcp_servers, alphhaspace_tools, thinking_default
...
def get_required_mcp_servers(
    ...
    - Respects per-project MCP config overrides from .alphhaspace/.env
    ...
    Args:
        ...
        mcp_config: Per-project MCP server toggles from .alphhaspace/.env
    ...
    # Process removals (but never remove alphhaspace)
    if remove_key in mcp_config:
        ...
        for server in removals:
            mapped = _map_mcp_server_name(server, custom_server_ids)
            if mapped and mapped != "alphhaspace":  # alphhaspace cannot be removed
