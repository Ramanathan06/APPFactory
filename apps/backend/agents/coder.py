...
async def run_autonomous_agent(
    ...
    Args:
        ...
        spec_dir: Directory containing the spec (alphhaspace/specs/001-name/)
    ...
    while True:
        ...
        if pause_file.exists():
            ...
            print("\nThen run again:")
            print(f"  python alphhaspace/run.py --spec {spec_dir.name}")
            return
    ...
    if completed < total:
        content = [
            ...
            f"Run again: {highlight(f'python alphhaspace/run.py --spec {spec_dir.name}')}",
        ]
    else:
        content = [
            ...
            "  1. Review the alphhaspace/* branch",
            "  2. Run manual tests",
            "  3. Merge to main",
        ]
