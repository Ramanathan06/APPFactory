...
def load_project_context(project_dir: str) -> str:
    ...
    # Load project index if available (from .alphhaspace - the installed instance)
    index_path = Path(project_dir) / ".alphhaspace" / "project_index.json"
    ...
    roadmap_path = Path(project_dir) / ".alphhaspace" / "roadmap" / "roadmap.json"
    ...
    # Load existing tasks
    tasks_path = Path(project_dir) / ".alphhaspace" / "specs"
