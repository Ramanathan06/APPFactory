...
class AuditLogger:
    ...
    Usage:
        audit = AuditLogger(log_dir=Path(".alphhaspace/github/audit"))
    ...
    def __init__(
        ...
        Args:
            log_dir: Directory for audit logs (default: .alphhaspace/github/audit)
        ...
        """
        self.log_dir = log_dir or Path(".alphhaspace/github/audit")
