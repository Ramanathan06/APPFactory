...
Usage:
    python alphhaspace/ideation_runner.py --project /path/to/project
    python alphhaspace/ideation_runner.py --project /path/to/project --types low_hanging_fruit,high_value_features
    python alphhaspace/ideation_runner.py --project /path/to/project --refresh
"""
...
# Add alphhaspace to path
sys.path.insert(0, str(Path(__file__).parent.parent))

# Load .env file from alphhaspace/ directory
...
def main():
    ...
    parser.add_argument(
        "--output",
        type=Path,
        help="Output directory for ideation files (default: project/alphhaspace/ideation)",
    )
    parser.add_argument(
        "--types",
        type=str,
