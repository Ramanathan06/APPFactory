...
Usage:
    python alphhaspace/roadmap_runner.py --project /path/to/project
    python alphhaspace/roadmap_runner.py --project /path/to/project --refresh
    python alphhaspace/roadmap_runner.py --project /path/to/project --output roadmap.json
"""
...
def main():
    ...
    parser.add_argument(
        "--output",
        type=Path,
        help="Output directory for roadmap files (default: project/alphhaspace/roadmap)",
    )
    parser.add_argument(
        "--model",
        type=str,
