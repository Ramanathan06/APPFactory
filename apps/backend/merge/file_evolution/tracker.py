...
class FileEvolutionTracker:
    ...
    - File content snapshots in .alphhaspace/baselines/
    ...
    def __init__(
        ...
        Args:
            ...
            storage_dir: Directory for evolution data (default: .alphhaspace/)
        ...
        storage_dir = storage_dir or (self.project_dir / ".alphhaspace")
