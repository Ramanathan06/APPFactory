...
def choose_workspace(
    ...
    """
    Let user choose where alphhaspace should work.
...
def copy_spec_to_worktree(
    ...
    # Use .alphhaspace/specs/{spec_name}/ as the standard location
    # Note: alphhaspace/ is source code, .alphhaspace/ is the installed instance
    target_spec_dir = worktree_path / ".alphhaspace" / "specs" / spec_name
