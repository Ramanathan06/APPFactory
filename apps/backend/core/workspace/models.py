...
class MergeLock:
    ...
    Uses a lock file in .alphhaspace/ to ensure only one merge operation
    ...
    def __init__(self, project_dir: Path, spec_name: str):
        ...
        self.lock_dir = project_dir / ".alphhaspace" / ".locks"
...
class SpecNumberLock:
    ...
    def get_next_spec_number(self) -> int:
        ...
        main_specs_dir = self.project_dir / ".alphhaspace" / "specs"
        ...
        if worktrees_dir.exists():
            for worktree in worktrees_dir.iterdir():
                if worktree.is_dir():
                    worktree_specs = worktree / ".alphhaspace" / "specs"
