...
# =============================================================================
# MOCK SETUP - Must happen before ANY imports from alphhaspace
# =============================================================================
...
def setup_qa_report_mocks() -> None:
    ...
    This function must be called before importing any alphhaspace modules.
    """
    ...
    # Add alphhaspace path for imports
