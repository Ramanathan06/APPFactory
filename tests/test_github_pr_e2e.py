...
def temp_github_dir(tmp_path):
    ...
    github_dir = tmp_path / ".alphhaspace" / "github"
...
class TestBotDetectionE2E:
    ...
    def test_full_bot_detection_flow(self, tmp_path):
        ...
        with patch.object(BotDetector, "_get_bot_username", return_value="alphhaspace[bot]"):
        ...
        bot_pr = {"author": {"login": "alphhaspace[bot]"}}
        bot_commits = [{"author": {"login": "alphhaspace[bot]"}, "oid": "bot_commit"}]
