...
- Default database path unified to ~/.alphhaspace/memories for consistency
...
- fix: unify default database path to ~/.alphhaspace/memories by @AndyMik90 in 684e3f9
...
- Required GitHub setup flow after Alphhaspace initialization to ensure proper configuration
...
- Untracked .alphhaspace directory to respect gitignore rules
...
- feat: add required GitHub setup flow after Alphhaspace initialization by @AndyMik90 in 03ccce5
- chore: remove redundant auto-claude/specs directory by @AndyMik90 in 64d5170
- chore: untrack .alphhaspace directory (should be gitignored) by @AndyMik90 in 0710c13
...
- Updated README to clarify Alphhaspace's role as an AI coding companion
...
- Removed .alphhaspace and _bmad-output from git tracking (already in .gitignore)
...
- chore: Remove .alphhaspace from tracking (already in .gitignore) by @AndyMik90 in 87f353c
...
- docs: Revise README.md to enhance clarity and focus on Alphhaspace's capabilities by @AndyMik90 in f9ef7ea
...
- Removed obsolete security configuration file (.alphhaspace-security.json)
