...
This document describes how releases are created for Alphhaspace.

## Overview

Alphhaspace uses an automated release pipeline that ensures releases are only published after all builds succeed. This prevents version mismatches between documentation and actual releases.
...
After merging, check:
- [GitHub Actions](https://github.com/AndyMik90/Alphhaspace/actions) - ensure all workflows pass
- [Releases](https://github.com/AndyMik90/Alphhaspace/releases) - verify release was created
- [README](https://github.com/AndyMik90/Alphhaspace#download) - confirm version updated
